...
/**
 * This class defines a Main class that reads names from the user and stores them into a dynamic array.
 *
...
public class Main {
    ...
    /**
     * The main method prompts the user to enter names and stores them in an array. The array expands dynamically.
     *
